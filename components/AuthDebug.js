...
export default function AuthDebug() {
  ...
  return (
    <div className="fixed bottom-20 left-2 right-2 z-999 max-h-[55vh] overflow-y-auto rounded-xl border border-yellow-500/50 bg-black/90 p-3 font-mono text-[10px] leading-relaxed text-yellow-300 backdrop-blur-sm">
